...
public class RealEstateController {
    ...
    public void finish() throws SQLException {
        ...
        RealEstateProduct realEstateProduct=new RealEstateProduct(Addr,name,id,AmountOfPeo,pic,pric,typ,prio);
        PackageControler.realEstateProducts.add(realEstateProduct);
        Alert alert = new Alert(Alert.AlertType.INFORMATION);
